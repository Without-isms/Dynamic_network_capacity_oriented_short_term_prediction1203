...
from archieve.models.Net_no_DO import Net_no_DO
...
def run_model(model, data_iterator, edge_index, edge_attr, device, seq_len, horizon, output_dim):
    ...
    for _, (x_od, y_od, unfinished, history, yesterday, xtime, ytime, PINN_od_features,
            PINN_od_additional_features,OD_feature_array, OD_path_compressed_array,
...
def main(args):
    ...
    model = Net_no_DO(cfg, logger).to(device)
