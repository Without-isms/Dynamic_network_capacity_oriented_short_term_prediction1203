...
class DONet(torch.nn.Module):
    ...
    def __init__(self, cfg, logger):
        ...
        self.logger = logger
        self.cfg = cfg
        additional_feature_dim = 10  # or any other number that represents the latent dimension size
        ...
        self.encoder_first_cells = GATRUCell(self.num_finished_input_dim,
                                            self.num_units,
                                            self.dropout_type,
                                            self.dropout_prob,
                                            self.num_relations,
        ...
        self.decoder_first_cells = GATRUCell(self.num_finished_input_dim,
                                            self.num_units,
                                            self.dropout_type,
                                            self.dropout_prob,
                                            self.num_relations,
